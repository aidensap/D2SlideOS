...
- "email_body": write in the SAME language as the user. Start with: Chinese: "下方是【{{report name}}】的{{定期/月度/每周}}数据报告，由 D2SlideOS 自动生成。" English: "Please find the {{schedule}} data report for [{{report name}}], auto-generated by D2SlideOS." Then add 1 sentence describing report content. End with: Chinese: "如有问题请回复本邮件。" English: "Reply to this email for questions." Sign off: "D2SlideOS · SAP"
